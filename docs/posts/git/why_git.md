...
2005년 리누즈 토발즈에 의해서 탄생한 Distributed VCS 툴인 Git은 프로젝트의 history를 remote repo 뿐만 아니라 개발자마다 local repo에서도 관리가 가능하다는 특징이 있습니다.
...
- 프로젝트 자체 또는 히스토리의 크기가 방대하다면 remote repo를 저장하기 위한 디스크 공간이 필요하고 local repo로 clone하는데 시간이 좀 걸릴 수 있습니다.
